...
CONFIG.PCW_S_AXI_HP0_DATA_WIDTH {32} CONFIG.PCW_TTC0_PERIPHERAL_ENABLE {0} \
...
CONFIG.PCW_USB0_RESET_IO {<Select>} CONFIG.PCW_USE_S_AXI_GP0 {0} \
CONFIG.PCW_USE_S_AXI_HP0 {1}  ] $processing_system7_0
  ...
  connect_bd_intf_net -intf_net rb_tx_v1_0_0_m00_axi [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins rb_tx_v1_0_0/m00_axi]
