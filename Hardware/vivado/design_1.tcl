...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set sig0 [ create_bd_port -dir I sig0 ]
  set sig1 [ create_bd_port -dir I sig1 ]
...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: rb_tx_v1_0_0, and set properties
  set rb_tx_v1_0_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:rb_tx_v1_0:1.0 rb_tx_v1_0_0 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins rb_tx_v1_0_0/s00_axi]
  connect_bd_intf_net -intf_net rb_tx_v1_0_0_m00_axi [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins rb_tx_v1_0_0/m00_axi]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rb_tx_v1_0_0/m00_axi_aclk] [get_bd_pins rb_tx_v1_0_0/s00_axi_aclk] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rb_tx_v1_0_0/m00_axi_aresetn] [get_bd_pins rb_tx_v1_0_0/s00_axi_aresetn] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]
  connect_bd_net -net sig0_1 [get_bd_ports sig0] [get_bd_pins rb_tx_v1_0_0/tx_data_in0]
  connect_bd_net -net sig1_1 [get_bd_ports sig1] [get_bd_pins rb_tx_v1_0_0/tx_data_in1]

  # Create address segments
  create_bd_addr_seg -range 0x10000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rb_tx_v1_0_0/s00_axi/reg0] SEG_rb_tx_v1_0_0_reg0
  create_bd_addr_seg -range 0x20000000 -offset 0x0 [get_bd_addr_spaces rb_tx_v1_0_0/m00_axi] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
...
preplace port sig0 -pg 1 -y 320 -defaultsOSRD
preplace port sig1 -pg 1 -y 340 -defaultsOSRD
...
preplace inst rb_tx_v1_0_0 -pg 1 -lvl 3 -y 360 -defaultsOSRD
...
preplace netloc rb_tx_v1_0_0_m00_axi 1 3 1 960
preplace netloc sig1_1 1 0 3 NJ 340 NJ 340 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 380 230 NJ 220 NJ 230 NJ 230 1720
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 320 NJ 260 NJ 250 NJ 250 NJ 250 1710
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1300
preplace netloc sig0_1 1 0 3 NJ 330 NJ 330 NJ
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 3 370 270 730 170 990
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 3 350 250 NJ 90 N
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 30 140 360 240 720 240 980 240 1290 440 1700
levelinfo -pg 1 0 190 540 850 1140 1500 1740 -top 0 -bot 470
",
}
